...
def inference(left_img_path: str, right_img_path: str, model, args: argparse.Namespace):
    ...
    if args.pc:
        ...
        doffs = 0
        K = np.array([1998.842, 0, 588.364, 0, 1998.842, 505.864, 0, 0, 1]).reshape(3, 3)
...
def parse_args() -> omegaconf.OmegaConf:
    ...
    parser.add_argument(
        "--pretrained", default="2024-12-13-23-51-11/model_best_bp2.pth", help="Path to pretrained model"
    )
