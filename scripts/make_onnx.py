...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_path", type=str, default=f"{code_dir}/../output/foundation_stereo.onnx", help="Path to save results."
    )
    parser.add_argument(
        "--ckpt_dir",
    ...
    torch.onnx.export(
        ...
        output_names=["disp"],
        dynamic_axes={"left": {0: "batch_size"}, "right": {0: "batch_size"}, "disp": {0: "batch_size"}},
    )
